      ...
      <RevealWrapper>
        <div className="flex flex-col gap-4">
          ...
          <p className="pb-10 leading-8">
            ...
            users' pain points were ultimately executed. Additionally,
            compromising on design choices within the team while simultaneously
            creating a product that everyone was proud of was an important
            lesson.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="pb-10">
            ...
            should be research driving the success of all of the moving pieces
            of the project.
          </p>
        </div>
