...
export default function Summary() {
  return (
    <section className="h-[100vh] flex flex-col justify-around items-center pl-[15%] pr-[15%]">
      <RevealWrapper>
        <div className="flex flex-wrap gap-6">
          <div className="flex flex-col w-[66%]">
            ...
            <p>
              ...
              fundamental necessity. We designed Sage: the app that advocates
              for socially accessible mental health and provides personalized
              self-care practices.{' '}
            </p>
          </div>
          ...
          <div className="flex flex-col w-[66%]">
            ...
            <p>
              ...
              pain points, culminating in the ideation of our solutions.
              Finalized our design system and spearheaded the creation of our
        ...
        <div className="flex flex-wrap gap-6">
          <div className="flex flex-col w-[45%]">
            ...
            <p>
              ⭐️ Awarded "Most Innovative UX" and "Best UX Research" by
