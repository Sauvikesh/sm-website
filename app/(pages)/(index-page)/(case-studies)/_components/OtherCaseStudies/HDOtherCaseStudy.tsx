...
export default function HackDavisCaseStudyThumbnail() {
  ...
  const purpose = 'FREELANCE PROJECT';
  const desc = 'Empowering students to create for social good';
  const src = '/caseStudies/hackdavis2.svg';
  ...
  return (
    <Link
      href={linkurl}
      className="flex flex-col w-[488px] h-[529px] flex-grow mb-20 px-10 pt-10 bg-[#F1F1F1] rounded-3xl border-[#CCC] border overflow-clip relative group hover:shadow-perimeter duration-500"
    >
