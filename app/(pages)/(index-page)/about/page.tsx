...
export default function About() {
  ...
  return (
    <main
      className={`flex flex-col overflow-x-clip relative gap-40 ${darkMode ? 'text-white bg-dark-bg' : 'text-black bg-white'} font-dm-sans transition-colors duration-500`}
    >
      <Bio />
      <Philosophy />
      <Hobbies />
