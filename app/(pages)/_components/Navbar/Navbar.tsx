...
export default function Navbar() {
  ...
  return !invisible ? (
    <header
      className={`fixed top-0 z-50 flex w-full justify-center bg-transparent pt-8 transition-all duration-300  ${isVisible ? 'opacity-1 translate-y-0' : 'opacity-0 -translate-y-full'}`}
    >
      <nav
